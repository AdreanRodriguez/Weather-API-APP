...
inputRef2.addEventListener("keypress", (e) => {
    ...
    if (e.key === "Enter") {
        hideElements();
        fetchWeather(e);
        (_a = document.querySelector(".display-weather-container")) === null || _a === void 0 ? void 0 : _a.classList.remove("hide");
        inputRef2.value = "";
    }
});
...
searchRefBlack === null || searchRefBlack === void 0 ? void 0 : searchRefBlack.addEventListener("click", () => {
    ...
    (_b = document.querySelector(".weather-logo")) === null || _b === void 0 ? void 0 : _b.classList.remove("hide");
    (_c = document.querySelector(".weather-slogan")) === null || _c === void 0 ? void 0 : _c.classList.remove("hide");
    (_d = document.querySelector(".weather-heading")) === null || _d === void 0 ? void 0 : _d.classList.remove("hide");
    (_e = document.querySelector("#inputField2")) === null || _e === void 0 ? void 0 : _e.classList.remove("hide");
    searchRefWhite.classList.remove("hide");
});
...
function displayWeatherData() {
    ...
    (_a = document.querySelector(".wind-image")) === null || _a === void 0 ? void 0 : _a.classList.remove("hide");
    (_b = document.querySelector(".humidity-image")) === null || _b === void 0 ? void 0 : _b.classList.remove("hide");
    const searchedLocation = document.querySelector(".weather-location-name");
